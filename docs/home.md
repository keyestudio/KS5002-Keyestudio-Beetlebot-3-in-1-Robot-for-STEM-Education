...
In folder **..\Codes\180° Servo Angle initialization_Codes** , open file **180°_Servo_Angle_initialization.py** , or copy and paste the above test code into the Thonny IDE.
